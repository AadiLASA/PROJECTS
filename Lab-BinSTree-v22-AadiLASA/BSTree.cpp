...
// void BST::help(node** parent, node** child){
//   if((*parent)==nullptr){
//     (*parent) = new node;
...
// bool BST::searchTree(int key, node *thing){
//   if(thing==nullptr){
//     return false;
//   }
//   if(key==thing->key_value){
//     return true;
//   }
//   else if(key>thing->key_value){
//     searchTree(key,thing->p_right);
//   }
//   return searchTree(key,thing->p_left);
// }
// /*
...
//         help(&tree, &pNode);
//     } else if (searchTree(pNode->key_value, root)) { // there is already a node with our key value
//         //Just return
//         return;
...
//     case_1(parent,loc);
//   }
//   else if(loc->p_right!=nullptr && loc->p_right !=nullptr){
...
//     node* success = loc->p_right;
//     node* sucP = loc;

//     while(success->p_left!=nullptr){
//       sucP=success;
//       success=success->p_left;
//     }
//   }
// }
...
// {
//     if(prnt==root)//if (we are at the root)
//     {
...
//     else
//     {
//      prnt->p_right=nullptr; // otherwise simply remove node
//     }
// }
